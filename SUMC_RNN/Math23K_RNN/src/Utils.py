...
def process_dataset(file, label2id_data_path, max_len: int, lower: bool):
    label2id_or_value = {}
    ...
    if isinstance(label2id_data_path, list):
        ...
        print('label2id_data_path parameter wrong !!! \n exit !!!')
        sys.exit()
    ...
    if isinstance(file, list):
        ...
        sys.exit()
    passed_count = 0
    for idd, raw_mwp in enumerate(dataset):
